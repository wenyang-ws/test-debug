...
function register(){
	...
	this.loginUrl = '/index.php?s=admin/market/login';
	this.tips = {
		nameEmpty: '请输入用户名',
    ...
    this.checkName = function() {
		...
		var that = this;
		$.ajax(this.url+"/index.php?s=user/user/check_require", {
         	data: { field: 'username', value: name},
         	dataType: 'jsonp',
